...
/* package Retrie-0.1.0.0 */
#define VERSION_Retrie "0.1.0.0"
#define MIN_VERSION_Retrie(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Retrie-0.1.0.0-CrPAOgY9s4j1SMLMg5QHZq"

#define CURRENT_PACKAGE_KEY "Retrie-0.1.0.0-CrPAOgY9s4j1SMLMg5QHZq"
